...
export default function NaverMap({
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "100%" }}>
      ...
      />
      {/* ── Custom +/- zoom buttons ── */}
      <div style={{ position: "absolute", right: "14px", bottom: "120px", display: "flex", flexDirection: "column", zIndex: 20, borderRadius: "8px", overflow: "hidden", boxShadow: "0 2px 10px rgba(0,0,0,0.18)" }}>
        <button
      ...
      <button
        ...
        style={{
          ...btnBase,
          position: "absolute", right: "14px", bottom: "76px", zIndex: 20,
          borderRadius: "8px",
      ...
      {/* ── 불편 제보하기 버튼 ── */}
      <button
        onClick={() => { window.location.href = "/proposals?type=report"; }}
        aria-label="불편 제보하기"
        style={{
          position: "absolute", right: "14px", bottom: "24px", zIndex: 20,
          display: "flex", alignItems: "center", gap: "6px",
          padding: "10px 18px",
          borderRadius: "24px",
          background: isCute ? "#FF7EB3" : BRAND_COLOR,
          color: "#fff",
        ...
        onMouseLeave={(e) => { e.currentTarget.style.transform = "scale(1)"; e.currentTarget.style.boxShadow = "0 3px 12px rgba(0,0,0,0.25)"; }}
      >
