...
export async function GET(
  ...
  try {
    ...
    const { data: candidate, error } = await supabaseAdmin
      .from("Candidate")
      .select("id, name, district, handle, profileImage, slogan, bio, party, candidateStatus, caucusStatus, electionId, electionType, phone, pinLat, pinLng, youtube, instagram, twitter, facebook, tiktok, kakao, naverBlog, articleUrl, articleTitle, election:Election!electionId(id, name, type)")
      .eq("id", id)
      .single();
