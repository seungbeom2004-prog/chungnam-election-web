...
const SECURITY_HEADERS = [
  ...
  // navercorp.com) — we use broad wildcards to avoid breakage in Chrome incognito.
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://oapi.map.naver.com https://*.naver.com https://*.naver.net https://*.pstatic.net https://*.navercorp.com https://www.google.com https://www.gstatic.com https://www.instagram.com",
      ...
      "connect-src 'self' https://*.supabase.co https://*.naver.com https://*.naver.net https://*.pstatic.net https://*.navercorp.com http://*.naver.net https://www.google.com https://www.gstatic.com",
      "worker-src 'self' blob:",
      "frame-src https://www.google.com https://www.youtube.com https://www.facebook.com https://www.instagram.com",
    ].join("; "),
  },
